...
SECRET_KEY = 'django-insecure-%#ar4qmu7x+9j(d3wubr=4%m$a21v=k&ud7e0!sp+!-gdagv0$'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'animals', # Имя вашей БД. Если вы создали черезе psql или IDE свою базу и хотите использовать его - пропишите его имя здесь
        'USER': 'postgres',
        'PASSWORD': 'password',
        'HOST': 'localhost',
